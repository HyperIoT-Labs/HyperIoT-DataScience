package it.acsoftware.hyperiot.spark.globalscalarmaximum
  ...
  def main(args: Array[String]) = {
    ...
    */
    ...
    val output = values
      ...
      .select(max(col("value")).as(outputName)) // compute mean // TODO: change colName value with name of input
