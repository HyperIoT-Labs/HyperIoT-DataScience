package it.acsoftware.hyperiot.spark.globalscalarminimum
  ...
  def main(args: Array[String]) = {
    ...
    */
    ...
    val output = values
      ...
      .select(min(col("value")).as(outputName)) // compute mean // TODO: change colName value with name of input
